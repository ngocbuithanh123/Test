function CToggle(iXPos, iYPos, oSprite, bActive, oParentContainer,iInBonusPanel, iChestIndex) {
    var _bActive;
    var _aCbCompleted;
    var _aCbOwner;
    var _oButton;
    ...
    this._init = function (iXPos, iYPos, oSprite, bActive, oParentContainer, iInBonusPanel, iChestIndex) {
    ...
    this.buttonRelease = function () {
		if(iInBonusPanel && !_bActive){
			return;
		}

        if(iInBonusPanel){
            s_oBonusPanel.ShowMoney(iChestIndex,iXPos,iYPos);
        }
    ...
    this.ChangeImage = function(State){
        _oButton.gotoAndStop("state_" + State);
        _bActive = State;
    };

    this._init(iXPos, iYPos, oSprite, bActive, oParentContainer, iInBonusPanel, iChestIndex);
}