...
function CCouponPopup(){
    ...
    this.Init = function(){
        ...
        BuyBut = new CTextButton(510 + (oSprite.width / 2), 570, -2, 2, oSprite, "BUY"," ", FONT_BOLD, "#ffffff", 38,Container);
    ...
    this.InitRightSide = function(){
        ...
        MinusBut = new CTextButton(675 + (oSprite.width / 2), 468, -2, 2, oSprite, " "," ", FONT_BOLD, "#ffffff", 38,Container);
        MinusBut.addEventListener(ON_MOUSE_UP, this.ChangeQuantityMinus, this);

        oSprite = s_oSpriteLibrary.getSprite('CouponPlus');
        PlusBut = new CTextButton(750 + (oSprite.width / 2), 468, -2, 2, oSprite, " "," ", FONT_BOLD, "#ffffff", 38,Container);
