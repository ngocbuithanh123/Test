function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        _oWildText = new createjs.Text(TEXT_HELP_WILD,"26px "+FONT_BOLD, "#ffff00");
        ...
        var oText = new createjs.Text(TEXT_HELP_BONUS1,"26px "+FONT_BOLD, "#ffff00");
        ...
        var oText2 = new createjs.Text(TEXT_HELP_BONUS2,"26px "+FONT_BOLD, "#ffff00");
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN,"26px "+FONT_BOLD, "#ffff00");
        oText.textAlign = "center";
        oText.x = 757;
        oText.y = 287 ;
        oText.lineWidth = 600;
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN2,"17px "+FONT_BOLD, "#ffff00");
        oText.textAlign = "center";
        oText.x = 757;
        oText.y = 398 ;
        oText.lineWidth = 400;
    ...
    this._createPayouts = function(oContainerPage, page){
		//621
        var aPos = [{x:613 ,y:128 },{x:943,y:128 },{x:463,y:310},{x:793,y:310},{x:1113,y:310},
                    {x:613,y:492},{x:943,y:492}, {x:441,y:486}, {x:441,y:486}, {x:441,y:486}];
        ...
        for(var i=iStart;i<iEnd;i++){
            ...
            for(var j=0;j<iLen;j++){
                var oTextMult = new createjs.Text("X"+(5-j),"30px "+FONT_REGULAR, "#ffffff");
                ...
                var oText = new createjs.Text(aSymbolPayouts[iLen-j-1],"30px "+FONT_REGULAR, "#ffff00");
                oText.textAlign = "center";
