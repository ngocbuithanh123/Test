function CSlotSettings(){
    ...
    this._initPaylines = function(){
        ...
        s_aPaylineCombo[5] = [{row:1,col:0},{row:0,col:1},{row:1,col:2},{row:0,col:3},{row:1,col:4}];
        s_aPaylineCombo[6] = [{row:1,col:0},{row:2,col:1},{row:1,col:2},{row:2,col:3},{row:1,col:4}];
        ...
        s_aPaylineCombo[10] = [{row:1,col:0},{row:0,col:1},{row:1,col:2},{row:2,col:3},{row:1,col:4}];
    ...
    this._initSymbolAnims = function(){
        ...
        var oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0}, 
                        animations: {  static: [0, 1],anim:[1,47] }
        };
        ...
        oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0}, 
                        animations: {  static: [0, 1],anim:[1,49] }
        };
        ...
        oData = {   
            framerate: 48,
            images: [s_oSpriteLibrary.getSprite('symbol_12_anim')], 
            // width, height & registration point of each sprite
            frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0}, 
            animations: {  static: [0, 1],anim:[1,47] }
        };

        s_aSymbolAnims[11] = new createjs.SpriteSheet(oData);

        oData = {   
            framerate: 48,
            images: [s_oSpriteLibrary.getSprite('symbol_13_anim')], 
            // width, height & registration point of each sprite
            frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: 0, regY: 0}, 
            animations: {  static: [0, 1],anim:[1,47] }
        };

        s_aSymbolAnims[12] = new createjs.SpriteSheet(oData);
    };
