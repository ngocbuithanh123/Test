...
function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this.InitTopButton = function(){
        ...
        _oInfoBut = new CTextButton(316 + (oSprite.width / 2), 44, 0, 5, oSprite, TEXT_PAYTABLE," ", FONT_ZDYK, "#ffffff", 17);
        _oInfoBut.addEventListener(ON_MOUSE_UP, this._onInfo, this);

        oSprite = s_oSpriteLibrary.getSprite('info_but');
        _oPreviewBut = new CTextButton(439 + (oSprite.width / 2), 44, 0, 5, oSprite, TEXT_PREVIEW," ", FONT_ZDYK, "#ffffff", 17);
        _oPreviewBut.addEventListener(ON_MOUSE_UP, this._onPreview, this);

        oSprite = s_oSpriteLibrary.getSprite('info_but');
        _oQuitBut = new CTextButton(930 + (oSprite.width / 2), 44, 0, 5, oSprite, "QUIT"," ", FONT_ZDYK, "#ffffff", 17);
    ...
    this.InitBottom1 = function(){
        ...
        _oLinesBox = new createjs.Bitmap(s_oSpriteLibrary.getSprite('LinesBox'));
        _oLinesBox.x = 275;
        _oLinesBox.y = 522;
        s_oAttachSection.addChild(_oLinesBox);

        _oTotalBetBox = new createjs.Bitmap(s_oSpriteLibrary.getSprite('TotalBetBox'));
        _oTotalBetBox.x = 407;
        _oTotalBetBox.y = 522;
        s_oAttachSection.addChild(_oTotalBetBox);
        
        oSprite = s_oSpriteLibrary.getSprite('but_maxbet_bg');
        _oMaxBetBut = new CTextButton(528 + (oSprite.width / 2), 545, 19, 2,oSprite,TEXT_MAX_BET," ",FONT_ZDYK,"#ffffff",14);
        _oMaxBetBut.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);

        oSprite = s_oSpriteLibrary.getSprite('but_autospin');
        _oAutoSpinBut = new CTextButton(675 + (oSprite.width / 2), 545, 0, 0, oSprite, TEXT_AUTOSPIN," ", FONT_GAME, "#ffffff", 0); //732
        _oAutoSpinBut.addEventListener(ON_MOUSE_UP, this._onAutoSpin, this);

        oSprite = s_oSpriteLibrary.getSprite('spin_but');
        _oSpinBut = new CTextButton(580 + (oSprite.width / 2), 543, -1, -4, oSprite, TEXT_SPIN," ", FONT_ZDYK, "#ffffff", 37);
        ...
        _oFreeSpinNumText = new createjs.Text("", "16px " + FONT_BOLD, "#4f2930");
        ...
        _oLinesTitText = new createjs.Text("LINES", "15px " + FONT_BOLD, "#4f2930");
        _oLinesTitText.x = 316;
        _oLinesTitText.y = 524;
        _oLinesTitText.textAlign = "center";
        _oLinesTitText.textBaseline = "alphabetic";
        s_oAttachSection.addChild(_oLinesTitText);

        _oBetTitText = new createjs.Text(TEXT_BET, "15px " + FONT_BOLD, "#4f2930");
        _oBetTitText.x = 452;
        _oBetTitText.y = 524;
        ...
        _oWinTitText = new createjs.Text("WIN", "15px " + FONT_BOLD, "#4f2930");
        _oWinTitText.x = 860;
        _oWinTitText.y = 524;
        ...
        _oWinningTitText = new createjs.Text("WINNINGS", "15px " + FONT_BOLD, "#4f2930");
        _oWinningTitText.x = 990;
        _oWinningTitText.y = 524;
    ...
    this.InitBottom2 = function(){
        ...
        _oRedeemBut = new CTextButton(670 + (oSprite.width / 2), 612, -2, 4, oSprite, "REDEEM"," ", FONT_ZDYK, "#ffffff", 17);
        _oRedeemBut.addEventListener(ON_MOUSE_UP, this._onRedeem, this);

        oSprite = s_oSpriteLibrary.getSprite('Btn2');
        _oAddEntriesBut = new CTextButton(825 + (oSprite.width / 2), 612, -2, 4, oSprite, "ADD ENTRIES"," ", FONT_ZDYK, "#ffffff", 17);
        _oAddEntriesBut.addEventListener(ON_MOUSE_UP, this._onAddEntries, this);

        _oEntriesTitText = new createjs.Text("ENTRIES", "15px " + FONT_BOLD, "#4f2930");
        _oEntriesTitText.x = 579;
        _oEntriesTitText.y = 586;
        ...
        _oNextTitText = new createjs.Text("NEXT", "15px " + FONT_BOLD, "#4f2930");
        _oNextTitText.x =  397;
        _oNextTitText.y = 586;
        ...
        _oOnNextResultToggle = new CToggle(443,580,oSprite,s_bAudioActive,s_oAttachSection);
