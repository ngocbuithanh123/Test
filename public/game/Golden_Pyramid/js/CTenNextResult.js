...
function CTenNextResult(){
    ...
    this.Init = function(){
        ...
        _oExitBtn = new CGfxButton(870,107,s_oSpriteLibrary.getSprite('ExitBtn'),_o10NextResultContainer);
        _oExitBtn.addEventListener(ON_MOUSE_UP, this.hide10NextResult, this);

        _oNextResutlText1 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText2 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText3 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText4 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText5 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText6 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText7 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText8 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText9 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNextResutlText10 = new createjs.Text(" ", "27px " + FONT_BOLD, "#4f2930");
        ...
        _oNumberText1 = new createjs.Text("1", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText1.x = 600;
        _oNumberText1.y = 185;
        ...
        _oNumberText2 = new createjs.Text("2", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText2.x = 600;
        _oNumberText2.y = 220;
        ...
        _oNumberText3 = new createjs.Text("3", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText3.x = 600;
        _oNumberText3.y = 255;
        ...
        _oNumberText4 = new createjs.Text("4", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText4.x = 600;
        _oNumberText4.y = 290;
        ...
        _oNumberText5 = new createjs.Text("5", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText5.x = 600;
        _oNumberText5.y = 325;
        ...
        _oNumberText6 = new createjs.Text("6", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText6.x = 600;
        _oNumberText6.y = 360;
        ...
        _oNumberText7 = new createjs.Text("7", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText7.x = 600;
        _oNumberText7.y = 395;
        ...
        _oNumberText8 = new createjs.Text("8", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText8.x = 600;
        _oNumberText8.y = 430;
        ...
        _oNumberText9 = new createjs.Text("9", "27px " + FONT_BOLD, "#4f2930");
        _oNumberText9.x = 600;
        _oNumberText9.y = 465;
        ...
        _oNumberText10 = new createjs.Text("10", "27px " + FONT_BOLD, "#4f2930");
