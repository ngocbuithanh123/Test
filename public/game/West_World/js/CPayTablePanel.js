function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN2,"20px "+FONT_BOLD, "#ffff00");
        oText.textAlign = "center";
        oText.x = 757;
        oText.y = 390 ;
        oText.lineWidth = 600;
    ...
    this._createPayouts = function(oContainerPage, page){
		//621
        var aPos = [{x:613 ,y:128 },{x:943,y:128 },{x:613,y:310},{x:943,y:310},{x:613,y:492},
                    {x:943,y:492},{x:943,y:492}, {x:441,y:486}, {x:441,y:486}, {x:441,y:486}];
