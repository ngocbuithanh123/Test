function CMain(oData)
{
    ...
    this._initSounds = function(){
        ...
        if(navigator.userAgent.indexOf("Opera")>0 || navigator.userAgent.indexOf("OPR")>0){
                ...
                createjs.Sound.registerSound("./sounds/Gun_Release.ogg", "GunRelease");
                createjs.Sound.registerSound("./sounds/Gun_Shot.ogg", "GunShot");
                ...
                createjs.Sound.registerSound("./sounds/Gun_Release.mp3", "GunRelease");
                createjs.Sound.registerSound("./sounds/Gun_Shot.mp3", "GunShot");
    ...
    this._loadImages = function(){
        ...
        //AVATAR FRAMES
        for(var k=0;k<20;k++){
            s_oSpriteLibrary.addSprite("avatar_idle_"+k,"./sprites/avatar/avatar_idle/avatar_idle_"+k+".png");
        }

        for(var t=0;t<50;t++){
            s_oSpriteLibrary.addSprite("avatar_win_"+t,"./sprites/avatar/avata-win/avatar_win_"+t+".png");
        }
        ...
        //LOAD BONUS SPRITES
        s_oSpriteLibrary.addSprite("target","./sprites/bonus/Shooting_Point.png");
		s_oSpriteLibrary.addSprite("bonus_bg","./sprites/bonus/bonus_bg.jpg");

        for(var k=0;k<28+1;k++){
            s_oSpriteLibrary.addSprite("Gun"+k,"./sprites/bonus/Pistol/Gun_"+k+".png");
        }

        for(var j=0;j<21; j++)
        {
            s_oSpriteLibrary.addSprite("Tins1_"+j,"./sprites/bonus/Tins/Tin_1/TinA_"+j+".png");
        }
            for(var a=0;a<21; a++)
            {
                s_oSpriteLibrary.addSprite("Tins2_"+a,"./sprites/bonus/Tins/Tin_2/TinB_"+a+".png");
            }
            for(var b=0;b<21; b++)
            {
                s_oSpriteLibrary.addSprite("Tins3_"+b,"./sprites/bonus/Tins/Tin_3/TinC_"+b+".png");
            }
            for(var c=0;c<34; c++)
            {
                s_oSpriteLibrary.addSprite("Tins4_"+c,"./sprites/bonus/Tins/Tin_4/Armature_animtion0_"+c+".png");
            }
            for(var d=0;d<21; d++)
            {
                s_oSpriteLibrary.addSprite("Tins5_"+d,"./sprites/bonus/Tins/Tin_5/TinE_"+d+".png");
            }
            for(var e=0;e<35; e++)
            {
                s_oSpriteLibrary.addSprite("Tins6_"+e,"./sprites/bonus/Tins/Tin_6/Armature_animtion0_"+e+".png");
            }
            for(var f=0;f<20; f++)
            {
                s_oSpriteLibrary.addSprite("Tins7_"+f,"./sprites/bonus/Tins/Tin_7/Armature_animtion0_"+f+".png");
            }
            for(var g=0;g<25; g++)
            {
                s_oSpriteLibrary.addSprite("Tins8_"+g,"./sprites/bonus/Tins/Tin_8/Armature_animtion0_"+g+".png");
            }
            for(var h=0;h<21; h++)
            {
                s_oSpriteLibrary.addSprite("Tins9_"+h,"./sprites/bonus/Tins/Tin_9/Armature_animtion0_"+h+".png");
            }
            for(var l=0;l<24; l++)
            {
                s_oSpriteLibrary.addSprite("Tins10_"+l,"./sprites/bonus/Tins/Tin_10/Armature_animtion0_"+l+".png");
            }
            for(var q=0;q<33; q++)
            {
                s_oSpriteLibrary.addSprite("Tins11_"+q,"./sprites/bonus/Tins/Tin_11/Armature_animtion0_"+q+".png");
            }
            for(var w=0;w<25; w++)
            {
                s_oSpriteLibrary.addSprite("Tins12_"+w,"./sprites/bonus/Tins/Tin_12/Armature_animtion0_"+w+".png");
            }
...
var s_oMsgBox;
var s_oGameSettings;
var s_CountImage = new Array(21,21,21,34,21,35,20,25,21,24,33,25);
//var s_aEggOccurence;