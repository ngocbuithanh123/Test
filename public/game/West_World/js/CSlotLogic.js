    ...
    if(iRandOccur < s_aSession["win_occurrence"]){
            ...
            do{
                ...
                if(bBonus === 1 ){
					...
					//console.log("GetResultToSpin: " + GetResultToSpin(_lineNumber, betPerLine, iCurMode, result));
...
function generLosingPattern(){
    ...
    for(var i=0;i<NUM_ROWS;i++){
        ...
        }while(_aRandSymbols[iRandIndex] === 8 || _aRandSymbols[iRandIndex] === 9 || _aRandSymbols[iRandIndex] === 7);
            ...
            if(j == 0){
                ...
                do{
                    ...
                    iRandSymbol = _aRandSymbols[iRandIndex];
                        ...
                        iRandSymbol === 8 || iRandSymbol === 9 || iRandSymbol === 7);
...
function generateRandomSymbols(bFreespin,bBonus){
    for(var i=0;i<NUM_ROWS;i++){
        ...
        for(var j=0;j<NUM_REELS;j++){
            do{
                ...
                iRandSymbol = _aRandSymbols[iRandIndex];
                _aFinalSymbols[i][j] = iRandSymbol;
            }while(iRandSymbol === 8 || iRandSymbol === 9);
        }
    }
    ...
    function checkWin(bFreespin,bBonus,iNumBettingLines){
        ...
        for(var k=0;k<iNumBettingLines;k++){
            ...
            while(iValue === 7 && iStartIndex<NUM_REELS){
                iNumEqualSymbol++;
