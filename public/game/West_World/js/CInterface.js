...
function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _oAudioToggle = new CTextButton(264, 38, 0, -1, oSprite, " ", " ", FONT_BOLD, "#fdf9bf", 15);
            _oAudioToggle.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
			_oAudioToggle.setVisible(true);
			
			 oSprite = s_oSpriteLibrary.getSprite('audio_icon_mute')
            _oAudioToggleMute = new CTextButton(264, 38, 0, -1, oSprite, " ", " ", FONT_BOLD, "#fdf9bf", 15);
    ...
    this.InitTopButton = function(){
        ...
        _oInfoBut = new CTextButton(287 + (oSprite.width / 2), 44, 0, 3, oSprite, TEXT_PAYTABLE," ", FONT_REGULAR, "#ffffff", 17);
        _oInfoBut.addEventListener(ON_MOUSE_UP, this._onInfo, this);

        oSprite = s_oSpriteLibrary.getSprite('info_but');
        _oPreviewBut = new CTextButton(409 + (oSprite.width / 2), 44, 0, 3, oSprite, TEXT_PREVIEW," ", FONT_REGULAR, "#ffffff", 17);
        _oPreviewBut.addEventListener(ON_MOUSE_UP, this._onPreview, this);

        oSprite = s_oSpriteLibrary.getSprite('info_but');
        _oQuitBut = new CTextButton(958 + (oSprite.width / 2), 44, 0, 3, oSprite, "QUIT"," ", FONT_REGULAR, "#ffffff", 17);
    ...
    this.InitBottom1 = function(){
        ...
        _oMaxBetBut = new CTextButton(528 + (oSprite.width / 2), 545, 9, 1,oSprite,TEXT_MAX_BET," ",FONT_REGULAR,"#ffffff",20);
        _oMaxBetBut.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);

        oSprite = s_oSpriteLibrary.getSprite('but_autospin');
        _oAutoSpinBut = new CTextButton(675 + (oSprite.width / 2), 545, -7, 3, oSprite, TEXT_AUTOSPIN," ", FONT_REGULAR, "#ffffff", 20); //732
        ...
        _oFreeSpinNumText = new createjs.Text(" ", "23px " + FONT_BOLD, "#ffffff");
        _oFreeSpinNumText.x = 875;
