...
function CCouponPopup(){
    ...
    this.Init = function(){
        ...
        BuyBut = new CTextButton(510 + (oSprite.width / 2), 570, -2, 2, oSprite, "BUY"," ", FONT_REGULAR, "#ffffff", 38,Container);
        BuyBut.addEventListener(ON_MOUSE_UP, this.BuyCoupon, this);
        
    };

    this.InitLeftSide = function(){
        TitleTxt = new createjs.Text("Print Shop", "42px " + FONT_REGULAR, "#ffffff");
        TitleTxt.x = 662;
        TitleTxt.y = 65;
        TitleTxt.alpha = 1;
