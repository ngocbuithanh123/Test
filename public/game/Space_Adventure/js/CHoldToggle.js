function CHoldToggle(iXPos, iYPos, oSprite, bActive, oParentContainer) {
    var _bActive;
    var _aCbCompleted;
    var _aCbOwner;
    var _oButton;
    ...
    this._init = function (iXPos, iYPos, oSprite, bActive, oParentContainer) {
		...
		_oParent = new createjs.Container();
		_oParent.visible = true;
		...
		_oParent.addChild(_oButton);
        _oParentContainer.addChild(_oParent);

        this._initListener();
    };
	
	this.setVisible = function(bVisible){
        _oParent.visible = bVisible;
    };
	...
	this.setIsHold = function(isHold){
		_isHold = isHold;
	};

    this.buttonRelease = function () {
		if(!_isClickHold && _isHold){
			return;
		}
        _oButton.scaleX = 1;
        _oButton.scaleY = 1;
