function CMain(oData){
    ...
    this._loadImages = function(){
		...
		for(var j=1;j<21;j++){
			s_oSpriteLibrary.addSprite("freespinAnim"+j,"./sprites/popup_gameplay/FreeSpinsPopup/FreeSpinsPopup_"+j+".png");
        }
		...
		s_oSpriteLibrary.addSprite("HoldBtn","./sprites/interface/HoldBtn.png");
		...
		s_oSpriteLibrary.addSprite("point","./sprites/bonus/point.png");
		s_oSpriteLibrary.addSprite("popupbonus","./sprites/bonus/PopupBonus.png");
		
		s_oSpriteLibrary.addSprite("bonus_bg","./sprites/bonus/bonus_bg.jpg");
        s_oSpriteLibrary.addSprite("bonus_ufo","./sprites/bonus/bonus_ufo.png");
        s_oSpriteLibrary.addSprite("hit_area_chicken","./sprites/bonus/hit_area_chicken.png");
        s_oSpriteLibrary.addSprite("bonus_prize","./sprites/bonus/bonus_prize.png");
