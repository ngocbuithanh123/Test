...
function CAddEntriesPopup(){
    ...
    this.Init = function(){
        ...
        BalanceTxt = new createjs.Text(balanceStr + TEXT_CURRENCY + _oProfile.GetWalletBalance().toFixed(2), "22px " + FONT_REGULAR, "#ffff00");
        BalanceTxt.x = 872;
        BalanceTxt.y = 200;
        BalanceTxt.alpha = 1;
        ...
        BankBalanceTxt = new createjs.Text(bankBalanceStr + TEXT_CURRENCY + _oProfile.GetBankBalance().toFixed(2), "22px " + FONT_REGULAR, "#ffff00");
