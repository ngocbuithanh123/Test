...
function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _oAudioToggle = new CTextButton(269, 38, 0, -1, oSprite, " ", " ", FONT_BOLD, "#fdf9bf", 15);
            _oAudioToggle.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
			_oAudioToggle.setVisible(true);
			
			 oSprite = s_oSpriteLibrary.getSprite('audio_icon_mute')
            _oAudioToggleMute = new CTextButton(269, 38, 0, -1, oSprite, " ", " ", FONT_BOLD, "#fdf9bf", 15);
    ...
    this.InitTopButton = function(){
        ...
        _oInfoBut = new CTextButton(296 + (oSprite.width / 2), 44, 0, 5, oSprite, TEXT_PAYTABLE," ", FONT_REGULAR, "#fce0ab", 19);
        _oInfoBut.addEventListener(ON_MOUSE_UP, this._onInfo, this);

        oSprite = s_oSpriteLibrary.getSprite('info_but');
        _oPreviewBut = new CTextButton(419 + (oSprite.width / 2), 44, 0, 5, oSprite, TEXT_PREVIEW," ", FONT_REGULAR, "#fce0ab", 19);
        _oPreviewBut.addEventListener(ON_MOUSE_UP, this._onPreview, this);

        oSprite = s_oSpriteLibrary.getSprite('info_but');
        _oQuitBut = new CTextButton(950 + (oSprite.width / 2), 44, 0, 5, oSprite, "QUIT"," ", FONT_REGULAR, "#fce0ab", 19);
    ...
    this.InitRightSide = function(){
        ...
        _oShow10ResultBut = new CTextButton(1085 + (oSprite.width / 2), 150, 0, 6, oSprite, " "," ", FONT_REGULAR, "#fce0ab", 24);
        _oShow10ResultBut.addEventListener(ON_MOUSE_UP, this.show10NextResult, this);

        oSprite = s_oSpriteLibrary.getSprite('Banner');
        _oBanner1But = new CTextButton(1092 + (oSprite.width / 2), 375, 0, 6, oSprite, " "," ", FONT_REGULAR, "#fce0ab", 24);
        _oBanner1But.addEventListener(ON_MOUSE_UP, this.showCoupon1, this);

        oSprite = s_oSpriteLibrary.getSprite('Banner');
        _oBanner2But = new CTextButton(1092 + (oSprite.width / 2), 550, 0, 6, oSprite, " "," ", FONT_REGULAR, "#fce0ab", 24);
    ...
    this.InitBottom1 = function(){
        ...
        _oMinusLineBut = new CTextButton(398 + (oSprite.width / 2), 543, 0, 0,oSprite," "," ",FONT_REGULAR,"#fce0ab",30);
        _oMinusLineBut.addEventListener(ON_MOUSE_UP, this._onMinusLine, this);

        oSprite = s_oSpriteLibrary.getSprite('PlusBtn');
        _oPlusLineBut = new CTextButton(458 + (oSprite.width / 2), 543, 0, 0, oSprite, " "," ", FONT_REGULAR, "#fce0ab", 30);
        _oPlusLineBut.addEventListener(ON_MOUSE_UP, this._onPlusLine, this);
        
        oSprite = s_oSpriteLibrary.getSprite('MinusBtn');
        _oMinusCoinBut = new CTextButton(365 + (oSprite.width / 2), 612, 0, 0, oSprite, " "," ",FONT_REGULAR,"#fce0ab",30);
        _oMinusCoinBut.addEventListener(ON_MOUSE_UP, this._onMinusBet, this);

        oSprite = s_oSpriteLibrary.getSprite('PlusBtn');
        _oPlusCoinBut = new CTextButton(438 + (oSprite.width / 2), 612, 0, 0, oSprite, " "," ", FONT_REGULAR, "#fce0ab", 30);
        _oPlusCoinBut.addEventListener(ON_MOUSE_UP, this._onPlusBet, this);

        oSprite = s_oSpriteLibrary.getSprite('but_maxbet_bg');
        _oMaxBetBut = new CTextButton(528 + (oSprite.width / 2), 545, 8, 0,oSprite,TEXT_MAX_BET," ",FONT_REGULAR,"#fce0ab",20);
        _oMaxBetBut.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);

        oSprite = s_oSpriteLibrary.getSprite('but_autospin');
        _oAutoSpinBut = new CTextButton(675 + (oSprite.width / 2), 545, -11, -2.5, oSprite, TEXT_AUTOSPIN," ", FONT_REGULAR, "#fce0ab", 17); //732
        _oAutoSpinBut.addEventListener(ON_MOUSE_UP, this._onAutoSpin, this);

        oSprite = s_oSpriteLibrary.getSprite('spin_but');
        _oSpinBut = new CTextButton(613 + (oSprite.width / 2), 540, 2, 1, oSprite, "PLAY"," ", FONT_REGULAR, "#fce0ab", 28);
        _oSpinBut.addEventListener(ON_MOUSE_UP, this._onSpin, this);

        _oNumLinesText = new createjs.Text(NUM_PAYLINES, "20px " + FONT_REGULAR, "#fce0ab");
        _oNumLinesText.x =  453;
        _oNumLinesText.y = 550;
        _oNumLinesText.textAlign = "center";
        _oNumLinesText.textBaseline = "alphabetic";
        s_oAttachSection.addChild(_oNumLinesText);
        
        _oCoinText = new createjs.Text(iCurBet.toFixed(2), "20px " + FONT_REGULAR, "#fce0ab");
        _oCoinText.x =  429;
        _oCoinText.y = 619;
        ...
        _oWinText = new createjs.Text(TEXT_CURRENCY + "0.00", "20px " + FONT_REGULAR, "#fce0ab");
        _oWinText.x = 860;
        _oWinText.y = 550;
        ...
        _oMoneyText = new createjs.Text(TEXT_CURRENCY + iMoney.toFixed(2) , "20px " + FONT_REGULAR, "#fce0ab");
        _oMoneyText.x = 992;
        _oMoneyText.y = 550;
        ...
        _oFreeSpinNumText = new createjs.Text("", "18px " + FONT_REGULAR, "#fce0ab");
        _oFreeSpinNumText.x = 860;
        _oFreeSpinNumText.y = 40;
        _oFreeSpinNumText.textAlign = "center";
        _oFreeSpinNumText.textBaseline = "alphabetic";
        s_oAttachSection.addChild(_oFreeSpinNumText);

        _oLinesTitText = new createjs.Text("LINES", "17px " + FONT_REGULAR, "#fce0ab");
        _oLinesTitText.x = 453;
        ...
        _oBetTitText = new createjs.Text(TEXT_BET, "17px " + FONT_REGULAR, "#fce0ab");
        _oBetTitText.x = 424;
        _oBetTitText.y = 590;
        ...
        _oWinTitText = new createjs.Text("WIN", "17px " + FONT_REGULAR, "#fce0ab");
        _oWinTitText.x = 860;
        _oWinTitText.y = 522;
        ...
        _oWinningTitText = new createjs.Text("WINNINGS", "17px " + FONT_REGULAR, "#fce0ab");
    ...
    this.InitBottom2 = function(){
        ...
        _oRedeemBut = new CTextButton(800 + (oSprite.width / 2), 617, -1, 4, oSprite, "REDEEM"," ", FONT_REGULAR, "#fce0ab", 17);
        _oRedeemBut.addEventListener(ON_MOUSE_UP, this._onRedeem, this);

        oSprite = s_oSpriteLibrary.getSprite('Btn2');
        _oAddEntriesBut = new CTextButton(935 + (oSprite.width / 2), 617, -1, 4, oSprite, "ADD ENTRIES"," ", FONT_REGULAR, "#fce0ab", 17);
        _oAddEntriesBut.addEventListener(ON_MOUSE_UP, this._onAddEntries, this);

        _oEntriesTitText = new createjs.Text("ENTRIES", "17px " + FONT_REGULAR, "#fce0ab");
        _oEntriesTitText.x = 724;
        ...
        _oEntriesText = new createjs.Text("50000", "20px " + FONT_REGULAR, "#fce0ab");
        _oEntriesText.x =  724;
        _oEntriesText.y = 618;
        ...
        _oNextTitText = new createjs.Text("NEXT", "17px " + FONT_REGULAR, "#fce0ab");
        _oNextTitText.x =  549;
        _oNextTitText.y = 589;
        ...
        _oNextResultText = new createjs.Text("$0.00", "20px " + FONT_REGULAR, "#fce0ab");
        _oNextResultText.x = 572;
        _oNextResultText.y = 618;
        ...
        _oOnNextResultToggle = new CToggle(596,583,oSprite,s_bAudioActive,s_oAttachSection);
