...
function CCouponPopup(){
    ...
    this.Init = function(){
        ...
        BuyBut = new CTextButton(510 + (oSprite.width / 2), 570, -2, 2, oSprite, "BUY"," ", FONT_BOLD, "#fce0ab", 38,Container);
        BuyBut.addEventListener(ON_MOUSE_UP, this.BuyCoupon, this);
        
    };

    this.InitLeftSide = function(){
        TitleTxt = new createjs.Text("Print Shop", "42px " + FONT_BOLD, "#ffffff");
        TitleTxt.x = 662;
        TitleTxt.y = 65;
        TitleTxt.alpha = 1;
        ...
        CouponCode = new createjs.Text("Coupon Code:", "22px " + FONT_BOLD, "#ffffff");
        CouponCode.x = 650;
        CouponCode.y = 110;
        CouponCode.alpha = 1;
        ...
        CategoryName = new createjs.Text("Category Name:", "22px " + FONT_BOLD, "#ffffff");
        CategoryName.x = 650;
        CategoryName.y = 155;
        ...
        CompanyName = new createjs.Text("Company Name:", "22px " + FONT_BOLD, "#ffffff");
        CompanyName.x = 650;
        CompanyName.y = 200;
        CompanyName.alpha = 1;
        ...
        PointRequired = new createjs.Text("Point Required:", "22px " + FONT_BOLD, "#ffffff");
        PointRequired.x = 650;
        PointRequired.y = 245;
        ...
        AvailableCoupons = new createjs.Text("Available Coupons:", "22px " + FONT_BOLD, "#ffffff");
        ...
        Description = new createjs.Text("Description:", "22px " + FONT_BOLD, "#ffffff");
        Description.x = 650;
        Description.y = 335;
        Description.alpha = 1;
        ...
        Quantity = new createjs.Text("Quantity:", "22px " + FONT_BOLD, "#ffffff");
        Quantity.x = 650;
        Quantity.y = 475;
        Quantity.alpha = 1;
    ...
    this.InitRightSide = function(){
        CouponCodeTxt = new createjs.Text("prs", "22px " + FONT_BOLD, "#fce0ab");
        CouponCodeTxt.x = 675;
        CouponCodeTxt.y = 110;
        ...
        CategoryNameTxt = new createjs.Text("Services", "22px " + FONT_BOLD, "#fce0ab");
        ...
        CompanyNameTxt = new createjs.Text("Print Shop", "22px " + FONT_BOLD, "#fce0ab");
        ...
        PointRequiredTxt = new createjs.Text("125", "22px " + FONT_BOLD, "#fce0ab");
        ...
        AvailableCouponsTxt = new createjs.Text("102", "22px " + FONT_BOLD, "#fce0ab");
        ...
        DescriptionTxt = new createjs.Text("Purchase 1 Back Massage and Receive 1 FREE Facial Massage (a $49.99 Value)", "22px " + FONT_BOLD, "#fce0ab");
        ...
        QuantityTxt = new createjs.Text("100", "22px " + FONT_BOLD, "#fce0ab");
        QuantityTxt.x = 723;
        QuantityTxt.y = 476;
        QuantityTxt.alpha = 1;
        ...
        MinusBut = new CTextButton(675 + (oSprite.width / 2), 468, -2, 2, oSprite, " "," ", FONT_REGULAR, "#ffffff", 38,Container);
        MinusBut.addEventListener(ON_MOUSE_UP, this.ChangeQuantityMinus, this);

        oSprite = s_oSpriteLibrary.getSprite('CouponPlus');
        PlusBut = new CTextButton(750 + (oSprite.width / 2), 468, -2, 2, oSprite, " "," ", FONT_REGULAR, "#ffffff", 38,Container);
