function CAnimSymbol(iX,iY,oParentContainer){
    ...
    this._init = function(iX,iY){
        ...
        _oAmountTextBack = new createjs.Text("","28px "+FONT_REGULAR, "#000");
        _oAmountTextBack.x = -14;
        _oAmountTextBack.y = -15;
        ...
        _oAmountText = new createjs.Text("X0","28px "+FONT_REGULAR, "#fce0ab");
        _oAmountText.x = -14;
        _oAmountText.y = -15;
        ...
        for(var i=1;i<NUM_SYMBOLS+1;i++){
                var oSprite = createSprite(s_aSymbolData[i], "slice_left",0,0,SYMBOL_WIDTH,SYMBOL_HEIGHT);
                oSprite.x = 0;
                oSprite.y = 0;
                ...
                var oSprite = createSprite(s_aSymbolData[i], "slice_right",0,0,SYMBOL_WIDTH,SYMBOL_HEIGHT);
                oSprite.x = 0;
                oSprite.y = 0;
    ...
    this.playAnim = function(iSymbolIndex,iAmountWin,bLast){
        ...
        }else if(iSymbolIndex <7){
            szSound = "symbol_3_4_5";
        }else if(iSymbolIndex === 7){
            szSound = "symbol_6";
        }else{
			szSound = "symbol_7_8_9";
		}
