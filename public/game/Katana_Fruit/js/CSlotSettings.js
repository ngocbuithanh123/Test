function CSlotSettings(){
    ...
    this._initSymbolSpriteSheets = function(){
        ...
        for(var i=1;i<NUM_SYMBOLS+1;i++){
            var oData = {   // image to use
                            ...
                            frames: {width: SYMBOL_SIZE, height: SYMBOL_SIZE, regX: SYMBOL_SIZE/2, regY: SYMBOL_SIZE/2}, 
    ...
    this._initSymbolSplashEffect = function(){
        ...
        s_aSymbolSplashId[2] = 0;
        s_aSymbolSplashId[3] = 1;
        s_aSymbolSplashId[4] = 0;
        s_aSymbolSplashId[5] = 2;
        s_aSymbolSplashId[6] = 0;
        s_aSymbolSplashId[7] = 1;
        s_aSymbolSplashId[8] = 3;
        s_aSymbolSplashId[9] = 3;
        s_aSymbolSplashId[10] = 3;
    };
