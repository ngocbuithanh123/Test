function CReelColumn(iIndex,iXPos,iYPos,iDelay){
    ...
    this.initContainer = function(iXPos,iYPos){
        ...
        for(var i=0;i<NUM_ROWS;i++){
             ...
             if(_iIndex <= 4){
                _aFinalSymbolCombo[i][_iIndex] = iRandSymbol;
             }
             var oSprite = createSprite(s_aSymbolData[iRandSymbol], "static",SYMBOL_WIDTH/2,SYMBOL_HEIGHT/2,SYMBOL_WIDTH,SYMBOL_HEIGHT);
             oSprite.stop();
             oSprite.x = iX;
             oSprite.y = iY;
