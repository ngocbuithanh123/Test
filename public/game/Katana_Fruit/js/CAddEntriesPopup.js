...
function CAddEntriesPopup(){
    ...
    this.Init = function(){
        ...
        TitleTxt = new createjs.Text(titleStr, "26px " + FONT_BOLD, "#fce0ab");
        TitleTxt.x = 664;
        TitleTxt.y = 150;
        TitleTxt.alpha = 1;
        ...
        BalanceTxt = new createjs.Text(balanceStr + TEXT_CURRENCY + _oProfile.GetWalletBalance().toFixed(2), "25px " + FONT_BOLD, "#ffff00");
        BalanceTxt.x = 882;
        BalanceTxt.y = 200;
        BalanceTxt.alpha = 1;
        ...
        BankBalanceTxt = new createjs.Text(bankBalanceStr + TEXT_CURRENCY + _oProfile.GetBankBalance().toFixed(2), "25px " + FONT_BOLD, "#ffff00");
        BankBalanceTxt.x = 502;
        ...
        MoneySelectTxt = new createjs.Text(moneySelectStr, "35px " + FONT_BOLD, "#fce0ab");
        ...
        ValueSelectTxt = new createjs.Text(TEXT_CURRENCY + valueAdd.toFixed(2), "37px " + FONT_BOLD, "#ffff00");
        ...
        WinBalanceCheckBox = new CToggle(707,190,oSprite,isWinBalanaceCheck,Container);
        ...
        BankBalanceCheckBox = new CToggle(322,190,oSprite,isBankBalanceCheck,Container);
	...
	this.InitMainButton = function(){
        ...
        AddEntriesBut = new CTextButton(370 + (oSprite.width / 2), 555, 0, -2, oSprite, "ADD ENTRIES"," ", FONT_BOLD, "#fce0ab", 21,Container);
        AddEntriesBut.addEventListener(ON_MOUSE_UP, this.DoAddEntries, this);

        oSprite = s_oSpriteLibrary.getSprite('AddEntriesBut2');
        BuyCouponBut = new CTextButton(570 + (oSprite.width / 2), 555, 0, 8, oSprite, "BUY COUPON ","FROM WINNINGS ", FONT_BOLD, "#fce0ab", 19,Container);
        BuyCouponBut.addEventListener(ON_MOUSE_UP, this.BuyCouponFromWining, this);

        oSprite = s_oSpriteLibrary.getSprite('AddEntriesBut2');
        BuyPointBut = new CTextButton(820 + (oSprite.width / 2), 555, 0, 8, oSprite, "BUY ADDITIONAL","COUPON POINTS ", FONT_BOLD, "#fce0ab", 19,Container);
