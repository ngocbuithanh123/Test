...
function CRedeemPopup(){
    ...
    this.Init = function(){
        ...
        TitleTxt = new createjs.Text(titleStr, "22px " + FONT_REGULAR, "#ffffff");
        TitleTxt.x = 664;
        TitleTxt.y = 150;
        TitleTxt.alpha = 1;
        ...
        BalanceTxt = new createjs.Text(balanceStr + TEXT_CURRENCY + _oProfile.GetWalletBalance().toFixed(2), "28px " + FONT_REGULAR, "#ffff00");
        BalanceTxt.x = 662;
        BalanceTxt.y = 200;
        BalanceTxt.alpha = 1;
        ...
        MoneySelectTxt = new createjs.Text(moneySelectStr, "30px " + FONT_REGULAR, "#ffffff");
        ...
        ValueSelectTxt = new createjs.Text(TEXT_CURRENCY + valueRedeem.toFixed(2), "37px " + FONT_REGULAR, "#ffff00");
        ...
        CashOutBut = new CTextButton(510 + (oSprite.width / 2), 570, -2, 2, oSprite, "CASH OUT"," ", FONT_REGULAR, "#ffffff", 36,Container);
    ...
    this.CheckMaxRedeem = function(){
        if(_oProfile.GetWalletBalance() <= 0){
            var str = "YOU HAVE NO \nWINNING BALANCE";
            this.ShowNotification(str,"30px ", 360, 2000);
            return true;
        }
        if(valueRedeem >= _oProfile.GetWalletBalance()){
            return true;
    ...
    this.CashOutSuccess = function(){
        ...
        var str = Success;
        this.ShowNotification(str, "30px ", 340, 4000);
        this.reset();
    };
    ...
    this.ShowNotification = function(str,fontsize,_y,_timeshow){
        ...
        _oNotification.showNotification(true,str,fontsize + FONT_REGULAR,_y);
        setTimeout(() => {
