...
function CAddEntriesPopup(){
    ...
    this.Init = function(){
        ...
        WinBalanceCheckBox = new CToggle(725,190,oSprite,isWinBalanaceCheck,Container);
        ...
        BankBalanceCheckBox = new CToggle(342,190,oSprite,isBankBalanceCheck,Container);
    ...
    this.AddEntriesSuccess = function(){
        ...
        var str = Success;
        this.ShowNotification(str, "30px ", 370, 4000);
        this.reset();
    };
	...
	this.BuyCouponFromWining = function(){
		...
		if(valueAdd < 1 || _oProfile.GetBankBalance() < 1){
			...
			this.ShowNotification(str, "30px ", 325, 4000);
			return;
		}
	...
	this.AddUpdateCustomerBankBalanceSuccess = function(str){
        ...
        this.reset();
        this.ShowNotification(str, "25px ", 310, 5000);
	};
