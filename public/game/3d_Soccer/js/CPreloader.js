...
function CPreloader(){
    ...
    this._init = function(){
       ...
       s_oSpriteLibrary.addSprite("progress_bar","./sprites/menu/progress_bar.png");
       s_oSpriteLibrary.addSprite("progress_bar_under","./sprites/menu/progress_bar_under.png");
    ...
    this.attachSprites = function(){
       ...
       var oSprite1 = s_oSpriteLibrary.getSprite('progress_bar_under');
       _oProgressBarUnder  = createBitmap(oSprite1);
       _oProgressBarUnder.x = CANVAS_WIDTH/2 - (oSprite1.width/2);
       _oProgressBarUnder.y = CANVAS_HEIGHT - 70;
       _oContainer.addChild(_oProgressBarUnder);
       ...
       _oLoadingText = new createjs.Text("","30px "+FONT_BOLD, "#fff");
