function CPayTablePanel(){
    ...
    this._init = function(){
        ...
        _oWildText = new createjs.Text(TEXT_HELP_WILD,"30px "+FONT_REGULAR, "#ffff00");
        ...
        var oText = new createjs.Text(TEXT_HELP_BONUS1,"30px "+FONT_REGULAR, "#ffff00");
        ...
        var oText2 = new createjs.Text(TEXT_HELP_BONUS2,"30px "+FONT_REGULAR, "#ffff00");
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN,"30px "+FONT_REGULAR, "#ffff00");
        oText.textAlign = "center";
        oText.x = 750;
        oText.y = 335 ;
        oText.lineWidth = 600;
        ...
        var oText = new createjs.Text(TEXT_HELP_FREESPIN2,"25px "+FONT_REGULAR, "#ffff00");
        oText.textAlign = "center";
        oText.x = 750;
        oText.y = 425 ;
        oText.lineWidth = 400;
    ...
    this._createPayouts = function(oContainerPage, page){
		//621
        var aPos0 = [{x:463,y:310},{x:793,y:310},{x:1113,y:310}];
				
        var aPos1 = [{x:613 ,y:128 },{x:943,y:128 },{x:463,y:310},{x:793,y:310},{x:1113,y:310},
                    {x:613,y:492},{x:943,y:492}];
                    ...
                    for(var i=iStart;i<iEnd;i++){
                        ...
                        for(var j=0;j<iLen;j++){
                            var oTextMult = new createjs.Text("X"+(5-j),fontsize +FONT_REGULAR, "#ffff00");
                            ...
                            var oText = new createjs.Text(aSymbolPayouts[iLen-j-1],fontsize +FONT_REGULAR, "#fffde5");
                            oText.textAlign = "center";
    ...
    this.highlightCombo = function(iSymbolValue,iNumCombo){
        _aWinComboText[iSymbolValue-1][NUM_REELS-iNumCombo].color = "#ffff00";
