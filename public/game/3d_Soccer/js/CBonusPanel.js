function CBonusPanel(){
    ...
    this._init = function(){
        ...
        _oButUpLeft = new CGfxButton(225,55,oSpriteBall,_oContainer);
        ...
        _oButDownLeft = new CGfxButton(565,345,oSpriteBall,_oContainer);
        _oButDownLeft.addEventListenerWithParams(ON_MOUSE_UP,this._onShot,this,BONUS_BUTTON_3);
        
        _oButUpRight = new CGfxButton(1280,155,oSpriteBall,_oContainer);
